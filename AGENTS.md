...
ai4comms is a Claude Code plugin for AI4comms. It is a **distribution artifact** — skills are authored in Workspace Studio and cherry-picked here for client deployment.
...
├── companies/ai4comms/  # Brand data (charter, logos, colors)
...
This plugin defaults to **AI4comms** brand data at `companies/ai4comms/`. Skills read `charter.json`, `logos/`, `images/`, and `tokens.css` from this path automatically — no prompt-time client selection needed.

For collaborative brands (e.g., "AI4comms x Partner"), skills fall back to the AI4comms charter for any missing fields.

**Slug discipline (`client_slug` is `ai4comms`):**
...
- Default brand: `companies/ai4comms/` — hardwired, no discovery needed
